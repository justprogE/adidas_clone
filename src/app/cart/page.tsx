...
const Cart = () => {
  ...
  return (
    <div className="w-[1600px] max-w-full px-[15px] mx-auto flex flex-wrap pt-[60px] 3xl:w-[1280px] xl:w-[1145px]">
      ...
      <div className="w-[25%] ml-[4.166666%] 3xl:w-[29%] xl:w-[37.5%] md:w-full md:ml-0 pb-[100px]">
        <span className="underline text-sm uppercase hover:bg-black hover:text-white font-bold tracking-[2px] cursor-pointer">
        ...
        <h5 className="mt-[60px] uppercase text-xl font-bold mb-[30px]">
          order summary
        </h5>
        ...
        <div>
          ...
          <div className="flex flex-wrap">
            {Object.entries(payment).map(([title, image]) => (
              <Image className="m-2 ml-0" key={title} src={image} alt={title} />
            ))}
          </div>
        </div>
      </div>
